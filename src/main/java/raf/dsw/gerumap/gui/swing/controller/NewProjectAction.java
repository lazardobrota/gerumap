...
public class NewProjectAction extends AbstractGerumapAction{
    ...
    public NewProjectAction() {
        ...
        putValue(SMALL_ICON, loadIcon("/images/pluss.png"));//jos uvek nemam nista u images paketu ali dodaje ikonicu za New Project, verovatno u MenuBar ako tamo napravimo instancu klase
